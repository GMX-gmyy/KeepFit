...
class KFPrivacyViewController: KFBaseViewController {
    ...
    private lazy var paraSecondLabel: UILabel = {
        let label = UILabel()
        label.text = "Last updated: July 26, 2023"
        label.textColor = .black
        label.textAlignment = .justified
        label.numberOfLines = 0
    ...
    private lazy var twentyfiveLabel: UILabel = {
        let label = UILabel()
        label.text = "●By email: 515841662@qq.com"
        label.textColor = .black
        label.textAlignment = .left
        label.numberOfLines = 0
        label.font = .systemFont(ofSize: 11)
